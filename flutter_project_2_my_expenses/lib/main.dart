...
class MyHomePage extends StatelessWidget {
  final List<Transaction> transactions = [
    Transaction(id: 't1', title: 'New Shoes', amount: 12.99, date: DateTime.now()),
    Transaction(id: 't2', title: 'Weekly Groceries', amount: 19.34, date: DateTime.now())
  ];
      ...
      body: Column(
        ...
        child: Container(
          ...
          child: Column(
            ...
            TextField(decoration: InputDecoration(labelText: 'Amoun'),),
